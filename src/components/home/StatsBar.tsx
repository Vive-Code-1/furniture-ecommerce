...
const StatsBar = () => {
  const customers = useCountUp(18, 2000);
  const productsCount = useCountUp(700, 2000);
  const satisfaction = useCountUp(95, 2000);

  return (
    <section className="py-12 md:py-16">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8" ref={customers.ref}>
          <motion.div
